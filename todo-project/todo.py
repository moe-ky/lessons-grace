...
def add_todo_item(todo_dict, item_id, description):
    todo_dict[item_id] = description
...
result: todo_item = {1: 'buy groceries', 2: 'clean the house', 3: 'walk the dog', 4: 'read a book'}
...
"""
if action == 'add':
    add_todo_item(todo_item, 5, details)
list_todo_items(todo_item)
